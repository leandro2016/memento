...
const DECKS = [
  ...
  },
  {
    ...
    images: [
      { id: 1, file: 'PHOTO-2026-07-01-12-41-40.jpg', label: 'Team 1' },
      { id: 2, file: 'PHOTO-2026-07-01-12-41-40[1].jpg', label: 'Team 2' },
      { id: 3, file: 'PHOTO-2026-07-01-12-41-40[2].jpg', label: 'Team 3' },
      { id: 4, file: 'PHOTO-2026-07-01-12-41-41[2].jpg', label: 'Team 4' },
      { id: 5, file: 'PHOTO-2026-07-01-12-41-43.jpg', label: 'Team 5' },
      { id: 6, file: 'PHOTO-2026-07-01-12-41-44[1].jpg', label: 'Team 6' },
      { id: 7, file: 'PHOTO-2026-07-01-12-41-44[3].jpg', label: 'Team 7' },
      { id: 8, file: 'PHOTO-2026-07-01-12-41-45[4].jpg', label: 'Team 8' },
      { id: 9, file: 'PHOTO-2026-07-01-12-41-46[4].jpg', label: 'Team 9' },
      { id: 10, file: 'PHOTO-2026-07-01-12-41-47.jpg', label: 'Team 10' },
      { id: 11, file: 'PHOTO-2026-07-01-12-41-47[5].jpg', label: 'Team 11' },
      { id: 12, file: 'PHOTO-2026-07-01-12-41-48.jpg', label: 'Team 12' },
      { id: 13, file: 'PHOTO-2026-07-01-12-41-48[2].jpg', label: 'Team 13' },
      { id: 14, file: 'PHOTO-2026-07-01-12-41-49.jpg', label: 'Team 14' },
      { id: 15, file: 'PHOTO-2026-07-01-12-41-49[3].jpg', label: 'Team 15' },
